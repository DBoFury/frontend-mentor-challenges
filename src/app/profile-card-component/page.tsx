  ...
  return (
    <div className="relative flex items-center justify-center h-screen font-kumbh-sans overflow-clip bg-pcc-dark-cyan">
      <main className="flex flex-col w-[14rem] h-[16.5rem] bg-white z-10 shadow-md rounded-2xl sm:h-[18rem] sm:w-[15.5rem] md:h-[20rem] md:w-[17rem] dt:h-[23rem] dt:w-[22rem]">
        <div className="bg-pcc-card w-full h-[35%] rounded-t-2xl bg-contain" />
        <div className="relative space-y-1 h-[40%] w-full flex flex-col justify-center items-center">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 rounded-full border-4 border-white -translate-y-1/2 bg-pcc-profile w-[5rem] h-[5rem] bg-contain bg-no-repeat bg-center sm:w-[5.5rem] sm:h-[5.5rem] md:w-[6rem] md:h-[6rem] dt:w-[6.5rem] dt:h-[6.5rem]" />
      ...
      <div className="absolute top-0 -translate-y-1/2 -translate-x-[53%] z-0 bg-pcc-pattern-top bg-contain bg-no-repeat w-[60rem] h-[60rem]" />
      <div className="absolute bottom-0 translate-y-[63.5%] translate-x-[48%] z-0 bg-pcc-pattern-bottom bg-center bg-contain bg-no-repeat w-[60rem] h-[60rem]" />
    </div>
  );
};
