  ...
  return (
    <div className="h-screen font-red-hat-text">
      <div className="relative flex items-center justify-center w-full h-full overflow-clip bg-gradient-to-b from-lct-blackish-blue to-lct-very-dark-blue">
        ...
        />
        <div
          className={`absolute bottom-12 right-0 z-10 h-full w-[200vw] ${
            process.env.NODE_ENV === "production"
              ? "bg-lct-pattern-hills-prod"
              : "bg-lct-pattern-hills"
          } bg-contain bg-bottom bg-no-repeat sm:w-[150vw] md:w-[100vw] lg:bottom-0`}
        />
        <div
          className={`absolute bottom-0 right-0 z-0 h-full w-[200vw] ${
            process.env.NODE_ENV === "production"
              ? "bg-lct-pattern-hills-prod"
              : "bg-lct-pattern-hills"
          } bg-contain bg-bottom bg-no-repeat sm:w-[150vw] md:w-[100vw] lg:hidden`}
        />
