...
const page = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen my-20 dt:flex-row dt:mx-10 dt:my-0">
      <Card
        image="/frontend-mentor-challenges/3-column-preview-card-component/icon-sedans.svg"
        name="sedans"
      ...
      />
      <Card
        image="/frontend-mentor-challenges/3-column-preview-card-component/icon-suvs.svg"
        name="suvs"
      ...
      />
      <Card
        image="/frontend-mentor-challenges/3-column-preview-card-component/icon-luxury.svg"
        name="luxury"
